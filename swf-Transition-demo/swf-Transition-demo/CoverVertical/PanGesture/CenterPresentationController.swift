...
class CenterPresentationController: UIPresentationController {
    ...
    private let margin = (x: CGFloat(30), y: CGFloat(30))
    ...
    override func presentationTransitionWillBegin() {
        ...
        overlayView.gestureRecognizers = [UITapGestureRecognizer(target: self,
                                                                 action: #selector(CenterPresentationController.overlayViewDidTouch(_:)))]
...
extension CenterPresentationController {
